...
INSERT INTO `spring_curso`.`authorities`(`user_id`, `authority`) VALUES (1, 'ROLE_USER');
INSERT INTO `spring_curso`.`authorities`(`user_id`, `authority`) VALUES (2, 'ROLE_ADMIN');
INSERT INTO `spring_curso`.`authorities`(`user_id`, `authority`) VALUES (2, 'ROLE_USER');

INSERT INTO `spring_curso`.`users`(`username`, `password`, `enabled`) VALUES ('hector', '$2a$10$uVGbr8f5kw.bjZQuX9A5aO5vjrHkkqH3P.fmmQ3G.QqaUz/9LuBfK', 1);
INSERT INTO `spring_curso`.`users`(`username`, `password`, `enabled`) VALUES ('admin', '$2a$10$NdOkKMeF4dfq5Q4jUhWzkO92cd5V74vt7Gbwrn7LMLNlhCxdAZm26', 1);
